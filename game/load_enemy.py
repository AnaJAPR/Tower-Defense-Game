...
# Creating an Enemy
enemy_1 = Enemy(wp.lvl1_waypoints, enemy_1_image, 1, 10, 60)
enemy_2 = Enemy(wp.lvl1_waypoints, enemy_2_image, 3, 5, 40)
enemy_3 = Enemy(wp.lvl1_waypoints, enemy_3_image, 2, 7, 30)
enemy_4 = Enemy(wp.lvl1_waypoints, enemy_4_image, 5, 1, 20)
